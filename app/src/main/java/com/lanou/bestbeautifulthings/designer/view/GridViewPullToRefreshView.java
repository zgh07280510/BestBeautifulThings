 ...
 */
public class GridViewPullToRefreshView extends LinearLayout {
    ...
    public GridViewPullToRefreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public GridViewPullToRefreshView(Context context) {
        super(context);
        init();
    }
    ...
    public interface OnFooterRefreshListener {
        public void onFooterRefresh(GridViewPullToRefreshView view);
    }
