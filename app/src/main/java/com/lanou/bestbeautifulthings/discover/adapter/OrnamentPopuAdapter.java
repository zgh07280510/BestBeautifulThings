 ...
 */
public class OrnamentPopuAdapter extends BaseAdapter {
    private SpinerBean bean;
    private Context context;


    public OrnamentPopuAdapter(Context context) {
    ...
    @Override
    public int getCount() {
        return bean.getData().getCategories().get(3).getSub_categories().size();
    }

    @Override
    public Object getItem(int position) {
        return bean.getData().getCategories().get(3).getSub_categories().get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.spinnerTv.setText(bean.getData().getCategories().get(3).getSub_categories().get(position).getName());
        return convertView;
    }
